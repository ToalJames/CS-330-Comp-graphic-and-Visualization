...
public:
	...
	// mouse scroll callback for handling camera speed adjustments
	...
	// --- CAMERA ACCESSOR ---
	// Returns the camera pointer so it can be passed to the SceneManager for lighting math
...
private:
	...
	// The actual camera object used for the 3D view
	Camera* m_pCamera;
